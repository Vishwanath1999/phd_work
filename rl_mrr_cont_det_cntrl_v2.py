...
if config['train']:
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            next_state, reward, done, terminal, achieved, _, ecav_ = env.step(state, action[0], desired_spectrum_tensor)
            # log perf action
        ...
        print('episode: ', i, 'score: %.2f' % score, 'average score: %.2f' % avg_score,'best score: %.2f' % best_score, 'n_steps:', n_steps, 'done:', done)
# '''